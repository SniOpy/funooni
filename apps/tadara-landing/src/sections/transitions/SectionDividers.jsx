...
export function ContentReasonsDivider() {
  return (
    <Divider aria-hidden="true">
      <svg viewBox="0 0 1440 112" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="tadara-soft-cream" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor={soft} />
            <stop offset="52%" stopColor="#ECEEE9" />
            <stop offset="100%" stopColor={cream} />
          </linearGradient>
        </defs>
        <path
          fill="url(#tadara-soft-cream)"
          d="M0,0 H1440 V52 C1080,112 360,112 0,52 Z"
        />
        <path
          fill="none"
...
export function ReasonsMoreLetterDivider() {
  return (
    <Divider aria-hidden="true">
      <svg viewBox="0 0 1440 112" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="tadara-cream-soft-2" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor={cream} />
            <stop offset="50%" stopColor="#EEF2F0" />
            <stop offset="100%" stopColor={soft} />
          </linearGradient>
